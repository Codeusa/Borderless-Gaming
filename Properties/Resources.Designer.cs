...
namespace BorderlessGaming.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   查找类似 Unable to save favorites. Do you have permission?\r\n\r\nDetailed Error: {0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Borderless Gaming encountered an error checking for updates. Restart the program to try again. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 A new version of Borderless Gaming is available. Would you like to go to the release page? 的本地化字符串。
        /// </summary>
